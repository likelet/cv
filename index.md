...
`2011 - 2016`    
__Sun Yat-sen Univerisity, School of life science, Guangzhou, Guangdong__

- PH.D.

`2016 - 2019`    
__Sun Yat-sen Univerisity, Cancer Center, Guangzhou, Guangdong__
...
* [GPS-SUMO](http://sumosp.biocuckoo.org)-GPS-SUMO: A tool for the prediction of sumoylation sites and SUMO-interaction motifs
* [IBS](http://ibs.biocuckoo.org) - An illustrator for the presentation and visualization of biological sequences
* [IDEA](https://github.com/likelet/IDEA) - IDEA: a web server for Interactive Differential Expression Analysis with R Packages
* [LncPipe](https://github.com/likelet/LncPipe) - LncPipe: A Nextflow-based pipeline for identification and analysis of long non-coding RNAs from RNA-Seq data;
* [CrossICC](https://github.com/bioinformatist/CrossICC) - CrossICC: Iterative consensus clustering of cross-platform gene expression data without adjusting batch effect.
* [DAtools](https://github.com/likelet/DAtools) - A collection of common data analysis comand in java language
* [PlotAppForTBtools](https://github.com/likelet/PlotAppForTBtools) - Interactive plot websever  for replot result from TBtools
